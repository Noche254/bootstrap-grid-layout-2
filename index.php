...
if( isset($_POST['submitButton']))
{
    ...
    //2. submit form data
    $inserdata = mysqli_query($conn, "INSERT INTO contactus(firstname, lastname, email, phonenumber, message)
     VALUES('$firstName', '$lastName', '$emailAddress', '$phoneNumber', '$message')");
     if($insertdata)
     {
...
<body>
 ...
 <!-- end navigation bar -->
    <main class="p-5 mb-4 bg-light">
        <h1 style="padding-top:80px;">Welcome, Dennis Otieno</h1>
        <p>
